// api/scanner-full.js - AC369 FUSION (Scanner Stabil Super Detail)
...
async function analyzeCoin(coin) {
  ...
  let ohlcv = [];
  let chartPatterns = [];
  let elliottWave = { wave: 'Konsolidasi', confidence: 20, description: '' };
  ...
  try {
    ...
    if (res.ok) {
      ...
      chartPatterns = detectPatterns(ohlcv);
